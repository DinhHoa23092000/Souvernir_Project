...
<body>
    <div class="header-container">
        ...
        <div class="contact_container">
            <p style="font-size: 20px;">Vui lòng đăng nhập để có thể liên hệ với chúng tôi!</p>
        </div>
        <?php } else { ?>
        <div class="contact_container">
            <div style="height: 50px; ">
                <marquee style="color:firebrick; font-weight:bold; font-size:20px;margin-top:10px;">Welcome to my shop,
                    <?php echo $_SESSION['name']."!"?></marquee>
            </div>
            <hr />
            <p style="font-size: 20px;"><img src="Souvernir/Contact/hello.png" width="100px" height="80px">Xin chào!
                Chúng tôi có thể giúp gì cho bạn?</p>
            <hr />
            <a href="contact2.php"><button
                    style="border: none; background: none; font-size: 20px; color:blue; text-align:center;">Trò chuyện
                    ngay<img src="Souvernir/Contact/chat.png" width="60px" height="50px"></button></a>
        </div>
        <?php } ?>
        <!--============================================PARTNERS AND LINKS===============================================-->
