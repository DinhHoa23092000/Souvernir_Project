    ...
    <div class="header-container">
        ...
        <div class="detail_container">
            ...
            <div class="flex2">
                ...
                <p style="font-weight: bold">Tên sản phẩm: <a
                        style="text-decoration: none; color:darkblue; font-weight: normal"><?php echo $Products[$vitri]->name;?></a>
                </p>
                <p style="font-weight: bold">Giá: <a
                        style="text-decoration: none; color:darkblue; font-weight: normal"><?php echo $Products[$vitri]->getPrice()."VND";?></a>
                </p>
                <p style="font-weight: bold">Loại sản phẩm: <a
                        style="text-decoration: none; color:darkblue; font-weight: normal"><?php echo $Products[$vitri]->getType();?></a>
                </p>
                <p style="font-weight: bold">Mô tả chi tiết: <a
                        style="text-decoration: none; color:darkblue; font-weight: normal"><?php echo $Products[$vitri]->detail;?></a>
                </p>
                <form action="" method="post">
                    <button name="insert_cart" class="detail_add" value="<?php echo $Products[$vitri]->id;?>"> THÊM VÀO
                        GIỎ HÀNG <i class="fa fa-shopping-cart" style="font-size:20px;color:red"></i></button>
                </form>
            </div>
        </div>
        <!--============================================PARTNERS AND LINKS===============================================-->
