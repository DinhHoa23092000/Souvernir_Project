        ...
        <div class="search_container">
            ...
            <div class="grid-container">
                ...
                <figure class="grid-item">
                    <img class="img-fluid d-block mx-auto" src="<?php echo $searchPro[$i][2] ?>"
                    ...
                    <figcaption>
                        ...
                        <?php 
                                        $proSearch = "SELECT id from Product where name='".$searchPro[$i][1]."'";
                                        $resultProSearch = $db->query($proSearch)->fetch_all();
                                        $idProSearch=$resultProSearch[0][0]-1;
                                    ?>
                        <form action="detail.php" method="get">
                            <button class="detail" name="detail" value="<?php echo $idProSearch?>">Xem Chi Tiết</button>
                        </form>
                    </figcaption>
                    <form action="" method="post">
                        <button name="insert_cart" value="<?php echo $idProSearch;?>"> <i class="fa fa-shopping-cart"
