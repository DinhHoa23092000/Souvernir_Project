    ...
    <div class="header-container">
        ...
        <div class="intro_container">
            <div class="flex1_intro">
                ...
                <p
                    style="font-size:25px; font-family:fantasy; margin-left:10px; margin-right: 10px; color:firebrick; margin-bottom: 50px">
                    Souvenir Shop <a href="#"
                        style="text-decoration: none; font-family: sans-serif; font-size: 14px; color:navy">là cửa hàng
                        bán quà lưu niệm được thành lập vào tháng 1-2020, đặt tại Đà Nẵng. Đây là cơ sở kinh doanh đồ
                        lưu niệm mới nhất tại Đà Nẵng với các loại sản phẩm đa dạng, phong phú. Khách hàng có thể thoải
                        mái lựa chọn các sản phẩm để làm quà tặng cho gia đình, người thân, bạn bè...Các sản phẩm ở cửa
                        hàng được sản xuất theo dây chuyền công nghệ hiện đại, thiết kế vô cùng kỹ xảo và tinh tế, nếu
                        thấy hứng thú với các sản phẩm của cửa hàng, hãy đén với chúng tôi bạn nhé!</a></p>
                <p style="font-weight: bold; color: red; margin-left:50px">Địa chỉ: <a href="#"
                        style="text-decoration: none; color: black; font-weight:normal">101B Lê Hữu Trác, Phước Mỹ, Sơn
                        Trà, Đà Nẵng</a></p>
                <p style="font-weight: bold; color: red; margin-left:50px">Số điện thoại: <a href="#"
                        style="text-decoration: none; color: black; font-weight:normal">(0511).354.0785</a></p>
                <p style="font-weight: bold; color:red; margin-left:50px">Hotline: <a href="#"
                        style="text-decoration: none; color: black;font-weight:normal">0905.009.987 – 0935.288.900</a>
                </p>
                <p style="font-weight: bold; color:red; margin-left:50px">Email: <a href="#"
                        style="text-decoration: none; color: black;font-weight:normal">hoa.dinh21@student.passerellesnumeriques.org</a>
                </p>
                <p style="font-weight: bold; color:red; margin-left:50px">Website: <a href="index.php"
                        style="text-decoration: none; color: black;font-weight:normal">souvenirshop.com</a></p>
            </div>
            <div class="flex2_intro">
                ...
                <ul class="list-group list-group-flush">
                    <li class="list-group-item"
                        style="border:solid; border-width:1px; border-color: firebrick; text-align:center;font-weight: bold">
                        <a href="#" style="text-decoration:none; color:black">QUÀ ĐỂ BÀN</a></li>
                    <li class="list-group-item"
                        style="border:solid; border-width:1px; border-color: firebrick; text-align:center;font-weight: bold">
                        <a href="#" style="text-decoration:none; color:black">QUÀ TẶNG PHA LÊ</a></li>
                    <li class="list-group-item"
                        style="border:solid; border-width:1px; border-color: firebrick; text-align:center;font-weight: bold">
                        <a href="#" style="text-decoration:none; color:black">GẤU BÔNG</a></li>
                    <li class="list-group-item"
                        style="border:solid; border-width:1px; border-color: firebrick; text-align:center;font-weight: bold">
                        <a href="#" style="text-decoration:none; color:black">MÓC KHÓA</a></li>
                    <li class="list-group-item"
                        style="border:solid; border-width:1px; border-color: firebrick; text-align:center;font-weight: bold">
                        <a href="#" style="text-decoration:none; color:black">BÚT</a></li>
                    <li class="list-group-item"
                        style="border:solid; border-width:1px; border-color: firebrick; text-align:center;font-weight: bold">
                        <a href="#" style="text-decoration:none; color:black">TIỆN ÍCH</a></li>
                    <li class="list-group-item"
                        style="border:solid; border-width:1px; border-color: firebrick; text-align:center;font-weight: bold">
                        <a href="#" style="text-decoration:none; color:black">ĐỒ MĨ NGHỆ</a></li>
                    <li class="list-group-item"
                        style="border:solid; border-width:1px; border-color: firebrick; text-align:center;font-weight: bold">
                        <a href="#" style="text-decoration:none; color:black">SẢN PHẨM SÀNH SỨ</a></li>
                </ul>
                <div class="top_body_content">
                    <hr width="10%" height="10px" align="center; color:black;">
                    <a href="index.php"
                        style="text-decoration: none; color:darkblue;font-weight: bold;font-style: italic; font-size:13px;">
                        <--Xem Shop-->
                    </a>
                    <hr width="10%" height="10px" align="center; color:black;">
                </div>
